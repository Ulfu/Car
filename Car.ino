...
const int rightMotorPin1 = 5; // connected to pin 10 on the H-bridge
const int rightMotorPin2 = 6; // connected to pin 15 on the H-bridge
const int enableLeftPin = 9;   // connected to pin 1 on the H-bridge
const int enableRightPin = 10;  // connected to pin 9 on the H-bridge

const int onButton = 4;

const int pingPin = 8; // connected to trigger pin
const int echoPin = 7;  // connected to echo pin
